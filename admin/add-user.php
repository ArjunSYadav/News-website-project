...
if(isset($_POST['save']))
{
    ...
    $obj->select('user',"username",null,null,"username ='{$user}' ",null,null,null);
    ...
    if(!empty($result))
    {
        ...
        $obj->insert('user',["first_name"=>$fname, "last_name"=>$lname, "username"=>$user, "password"=>$password, "role"=>$role]);
